...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" method="post" action="<?php echo base_url(); ?>posts/create_post_poll_submit">
            ...
            <div class="form-group">
                    ...
                    <div class="tt-js-active-btn tt-wrapper-btnicon">
                        <div class="row tt-w410-col-02" id="post_types">
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_discussion" class="tt-button-icon">
                                    <span class="tt-icon">
                                        <svg>
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_question" class="tt-button-icon">
                                    <span class="tt-icon">
                                         <svg>
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_poll" class="tt-button-icon active">
                                    <span class="tt-icon">
                                            <svg>
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_gallery" class="tt-button-icon">
                                    <span class="tt-icon">
                                         <svg>
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_video" class="tt-button-icon">
                                    <span class="tt-icon">
                                         <svg>
                    ...
                    <input type="hidden" name="post_type" id="post_type" value="Poll">
                </div>
            ...
            <!-- Post Title -->
                ...
                <div class="form-group">
                    ...
                    <div class="tt-value-wrapper">
                        <input type="text" name="post_title" class="form-control" id="inputTopicTitle" placeholder="Subject of your poll" 
                    ...
                    <span class="helper-text"><?php echo form_error('post_title'); ?></span>
                </div>
            ...
            <!-- Post Title End -->
                ...
                <div class="pt-editor">
                    ...
                    <!-- <div>
                        ...
                        <div class="form-group">
                            <textarea name="post_body" class="form-control" rows="5" placeholder="Lets get started"><?php echo set_value('post_body'); ?></textarea>
                            <span class="helper-text"><?php echo form_error('post_body'); ?></span>
                        </div>
                    </div> -->

                    <div class="form-group">
                        <label for="inputTopicTitle">Option 1</label>
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_opt1" class="form-control" id="inputTopicTitle" placeholder="Enter option 1" 
                            value="<?php echo set_value('post_opt1'); ?>">                  
                        </div>
                        <span class="helper-text"><?php echo form_error('post_opt1'); ?></span>
                    </div>

                    <div class="form-group">
                        <label for="inputTopicTitle">Option 2</label>
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_opt2" class="form-control" id="inputTopicTitle" placeholder="Enter option 2" 
                            value="<?php echo set_value('post_opt2'); ?>">                  
                        </div>
                        <span class="helper-text"><?php echo form_error('post_opt2'); ?></span>
                    </div>

                    <div class="form-group">
                        <label for="inputTopicTitle">Option 3</label>
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_opt3" class="form-control" id="inputTopicTitle" placeholder="Enter option 3" 
                            value="<?php echo set_value('post_opt3'); ?>">                   
                        </div>
                        <span class="helper-text"><?php echo form_error('post_opt3'); ?></span>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="inputTopicTitle">Channel</label>
                                <select class="form-control" name="post_ch_id">
                                    <option selected disabled value="0">Select</option>
                                    <?php
                                        foreach ($channels as $ch) { ?>
                                                                
                                        <option value="<?php echo $ch->ch_id; ?>"><?php echo $ch->ch_title; ?></option>

                                        <?php }
                                    ?>
                                </select>
                                <span class="helper-text"><?php echo form_error('post_ch_id'); ?></span>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            // function onPostTypeChange(selectedType) {
            //     $("#post_type").val(selectedType);
            //     renderForm(selectedType);
            // }
            function renderForm(selectedType) {

                $("#discussion-question").hide();
                $("#poll").hide();
                $("#gallery-video").hide();

                if(selectedType == "Discussion" || selectedType == "Question") {
                    $("#discussion-question").show();
                    $("#poll").hide();
                    $("#gallery-video").hide();
                }
                ...
                else if(selectedType == "Gallery" || selectedType == "Video") {
                    $("#discussion-question").hide();
                    $("#poll").hide();
                    $("#gallery-video").show();
                } 
