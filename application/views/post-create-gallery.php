...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" method="post" action="<?php echo base_url(); ?>posts/create_post_gallery_submit" enctype="multipart/form-data">
            ...
            <div class="form-group">
                    ...
                    <div class="tt-js-active-btn tt-wrapper-btnicon">
                        <div class="row tt-w410-col-02" id="post_types">
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_gallery" class="tt-button-icon active">
                                    <span class="tt-icon">
                                         <svg>
                    ...
                    <input type="hidden" name="post_type" id="post_type" value="Gallery">
                </div>
            ...
            <!-- Post Type End -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_title" class="form-control" id="inputTopicTitle" placeholder="Subject of your image" 
                ...
                <div class="pt-editor">
                    ...
                    <div class="form-group">
                        <label for="inputTopicTitle">Upload Image</label>
                        <div class="tt-value-wrapper">
