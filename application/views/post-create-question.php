...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" method="post" action="<?php echo base_url(); ?>posts/create_post_question_submit">
            ...
            <div class="form-group">
                    ...
                    <div class="tt-js-active-btn tt-wrapper-btnicon">
                        <div class="row tt-w410-col-02" id="post_types">
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_question" class="tt-button-icon active">
                                    <span class="tt-icon">
                                         <svg>
            ...
            <!-- Post Title -->
                ...
                <div class="form-group">
                    ...
                    <div class="tt-value-wrapper">
                        <input type="text" name="post_title" class="form-control" id="inputTopicTitle" placeholder="What do you want to ask?" 
