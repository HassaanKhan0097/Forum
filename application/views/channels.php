...
<main id="tt-pageContent">
    <div class="tt-custom-mobile-indent container">
        <div class="tt-categories-title">
            <div class="tt-title">Channels</div>
            <div class="tt-search">
                <form class="search-wrapper">
                    <div class="search-form">
                        <input type="text" class="tt-search__input" placeholder="Search Channels">
                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            <ul class="tt-list-badge">
                                <li><a href="<?php echo base_url(); ?>posts/search?channel=<?php echo $ch->ch_id; ?>"><span class="tt-color0<?php echo $ch->ch_id; ?> tt-badge"><?php echo $ch->ch_title; ?></span></a></li>
                            </ul>
                            <h6 class="tt-title"><a href="<?php echo base_url(); ?>posts/search?channel=<?php echo $ch->ch_id; ?>">
								Threads - <?php echo $ch->posts_count; ?></a></h6>
                        </div>


                        <div class="tt-item-body">
                            <div class="innerwrapper">
                               <img src="<?php echo $this->config->item('upload_dir'); ?>forum/channels/<?php echo $ch->ch_img; ?>" alt="" srcset="">
                           </div>
                        </div>
