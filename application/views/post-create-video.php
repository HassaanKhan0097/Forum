...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" method="post" action="<?php echo base_url(); ?>posts/create_post_video_submit" enctype="multipart/form-data">
            ...
            <div class="form-group">
                    ...
                    <div class="tt-js-active-btn tt-wrapper-btnicon">
                        <div class="row tt-w410-col-02" id="post_types">
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_poll" class="tt-button-icon">
                                    <span class="tt-icon">
                                            <svg>
                            ...
                            <div class="col-4 col-lg-3 col-xl-2">
                                <a href="<?php echo base_url(); ?>posts/create_post_video" class="tt-button-icon active">
                                    <span class="tt-icon">
                                         <svg>
            ...
            <!-- Post Type End -->
                ...
                <!-- Post Title -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_title" class="form-control" id="inputTopicTitle" placeholder="What's on your mind?" 
                ...
                <div class="pt-editor">
                    ...
                    <div class="form-group">
                        <label for="inputTopicTitle">Upload Video</label>
                        <div class="tt-value-wrapper">
                            <input type="file" name="post_body" class="form-control file-control" id="inputTopicTitle" placeholder="Enter option 1" 
                            value="<?php echo set_value('post_body'); ?>">                  
                        </div>
                        
                        <br/> <span><b>OR</b></span> <br/><br/>
                        <div class="tt-value-wrapper">
                            <input type="text" name="post_body_URL" class="form-control" id="inputTopicTitle" placeholder="Enter Youtube Video URL " 
                            value="<?php echo set_value('post_body_URL'); ?>">
                            <span class="tt-value-input">99</span>                    
                        </div>
                        <div class="tt-note">Copy the link from address bar on youtube and paste it here.</div>
                        <span class="helper-text"><?php echo form_error('post_body_URL'); ?></span>
                    </div>
